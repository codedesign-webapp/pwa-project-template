<template>
  <v-container>
    ...
    <div class="text-center my-3">
      ...
      &nbsp;
      <v-btn color="black" fab dark bottom @click="fnToggleFrontRear()">
  ...
  export default {
    ...
    data() {
      return {
        ...
        bIsWait: false,
        bIsFront: false,  // 전면 후면 카메라 사용 상태값
      }
    },
    mounted() {
      this.fnGetUserMedia();
    ...
    methods: {
      fnGetUserMedia() {
        ...
        navigator.mediaDevices.getUserMedia({
          video: {
            facingMode: (this.bIsFront ? "user" : "environment")
          }
        }).then(pVideoStream => {
      ...
      fnToggleFrontRear() {
        this.bIsFront = !this.bIsFront;        
        this.fnReleaseUserMedia();
        this.fnGetUserMedia();    
        console.log(this.bIsFront);
      },
      fnCameraCapture() {
        this.bIsWait = true
